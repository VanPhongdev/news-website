...
const Footer = () => {
    return (
        <footer className="bg-white border-t border-slate-200 pt-12 pb-8 px-4 lg:px-10 mt-10">
            <div className="max-w-[1280px] mx-auto flex flex-col gap-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="flex flex-col gap-3">
                        <h4 className="text-slate-900 font-bold mb-1">Chuyên Mục</h4>
                        <p className="text-slate-500 text-sm">Thời sự</p>
                        <p className="text-slate-500 text-sm">Kinh doanh</p>
                        <p className="text-slate-500 text-sm">Công nghệ</p>
                        <p className="text-slate-500 text-sm">Thể thao</p>
                    </div>

                    {/* Links Column 2 */}
                    <div className="flex flex-col gap-3">
                        <h4 className="text-slate-900 font-bold mb-1">Thông Tin</h4>
                        <p className="text-slate-500 text-sm">Về chúng tôi</p>
                        <p className="text-slate-500 text-sm">Liên hệ quảng cáo</p>
                        <p className="text-slate-500 text-sm">Điều khoản sử dụng</p>
                        <p className="text-slate-500 text-sm">Chính sách bảo mật</p>
                    </div>

                    {/* Contact Column */}
                    <div className="flex flex-col gap-3">
                        <h4 className="text-slate-900 font-bold mb-1">Liên Hệ</h4>
