    ...
    return (
        <div className="relative flex min-h-screen w-full bg-background-light dark:bg-background-dark font-display">
            ...
            <div className="flex items-center justify-center w-full p-4 py-20">
                <div className="w-full max-w-[520px] bg-white dark:bg-gray-800 rounded-xl shadow-md border border-[#e5e7eb] dark:border-gray-700 overflow-hidden">
                    {/* Registration Header */}
                    <div className="p-8 pb-0 text-center">
                        <h1 className="text-[#111418] dark:text-white text-2xl font-bold mb-2">Đăng ký tài khoản</h1>
                        <p className="text-[#637588] dark:text-gray-400 text-sm">Tạo tài khoản để cập nhật tin tức nóng hổi mỗi ngày</p>
                    </div>
                    ...
                    <div className="p-8">
                        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-2">
                                <label className="text-[#111418] dark:text-gray-200 text-sm font-medium">Tên hiển thị</label>
                            ...
                            {/* Email Field */}
                            <div className="flex flex-col gap-2">
                                <label className="text-[#111418] dark:text-gray-200 text-sm font-medium">Email</label>
                                <div className="relative">
                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#637588]">
                            ...
                            {/* Password Field */}
                            <div className="flex flex-col gap-2">
                                <label className="text-[#111418] dark:text-gray-200 text-sm font-medium">Mật khẩu</label>
                                <div className="relative">
                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#637588]">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-4 top-1/2 -translate-y-1/2 text-[#637588] hover:text-[#111418] dark:hover:text-white"
                                    >
                            ...
                            <div className="flex flex-col gap-2">
                                <label className="text-[#111418] dark:text-gray-200 text-sm font-medium">Xác nhận mật khẩu</label>
                                <div className="relative">
                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#637588]">
                            ...
                            <div className="flex items-start gap-3 pt-2">
                                ...
                                />
                                <label htmlFor="terms" className="text-sm text-[#3f4d5a] dark:text-gray-400 leading-snug">
                        ...
                        <div className="relative py-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="bg-white dark:bg-gray-800 px-2 text-gray-500 dark:text-gray-400">Hoặc đăng ký bằng</span>
                            </div>
                        </div>

                        {/* Social Login */}
                        <div className="grid grid-cols-2 gap-4">
                            <button className="flex items-center justify-center gap-3 h-11 px-4 rounded-lg border border-[#dbe0e6] dark:border-gray-600 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                            ...
                            <button className="flex items-center justify-center gap-3 h-11 px-4 rounded-lg border border-[#dbe0e6] dark:border-gray-600 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                                ...
                                <span className="text-sm font-medium text-[#111418] dark:text-white">Facebook</span>
                            </button>
                        </div>
                    </div>

                    {/* Footer Link */}
                    <div className="bg-gray-50 dark:bg-gray-900/50 p-6 text-center border-t border-[#e5e7eb] dark:border-gray-700">
