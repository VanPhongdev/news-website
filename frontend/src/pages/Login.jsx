...
const Login = () => {
    ...
    return (
        <div className="relative flex h-screen w-full bg-background-light dark:bg-background-dark font-display">
            <div className="flex w-full">
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
                    <div className="w-full max-w-md">
                        {/* Header */}
                        <div className="mb-8">
                            <h1 className="text-[#111418] dark:text-white text-3xl font-bold mb-2">Chào mừng trở lại</h1>
                            <p className="text-[#637588] dark:text-gray-400 text-sm">Đăng nhập để tiếp tục theo dõi tin tức mỗi ngày</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex flex-col gap-2">
                                <label className="text-[#111418] dark:text-gray-200 text-sm font-medium">Email hoặc Tên đăng nhập</label>
                        ...
                        <div className="relative py-6">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="bg-background-light dark:bg-background-dark px-2 text-gray-500 dark:text-gray-400">Hoặc tiếp tục với</span>
                            </div>
                        </div>
